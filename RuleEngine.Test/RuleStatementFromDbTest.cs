...
namespace RuleEngine.Test
{
    ...
    ///</summary>
    [TestClass()]
    public class RuleStatementFromDbTest
    {
        /// <summary>
        ...
        public void EagerLoadingTest()
        {
            ...
            var repository = new GenericRepository<RuleStatement>(uoW);
            var include = new[] { "tblRuleSets.tblRules" };
            var ruleStatement = repository.GetFirst(x => x.Id == 1, include);
            const bool expected = false;
            var actual = ruleStatement.IsSatisfied(new RuleValidationService(vehicle));
